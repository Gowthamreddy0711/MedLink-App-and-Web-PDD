          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="mt-1.5">
                {doctor.coverageRatingCount || doctor.sentimentScoreCount ? (
                  <span className="flex items-center gap-1 text-xs font-bold text-slate-800">
                    <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                    {doctor.coverageScore ?? 100} / 100 <span className="font-medium text-slate-500 text-[10px] ml-0.5">({doctor.sentimentScoreCount || doctor.coverageRatingCount} Reviews)</span>
                  </span>
                ) : (
